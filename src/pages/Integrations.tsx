...
const Integrations = () => {
  const integrationCategories = [
    {
      ...
      integrations: [
        ...
        {
          name: "Telegram",
          description: "Send form responses to Telegram channels",
          logo: "telegram.svg",
          status: "available",
          popular: false
        },
    ...
    },
    {
      ...
      integrations: [
        {
          name: "Mailchimp",
          description: "Sync form responses with Mailchimp lists",
          logo: "mailchimp.svg",
          status: "available",
          popular: true
        },
        ...
        {
          name: "ActiveCampaign",
          description: "Trigger ActiveCampaign automations",
          logo: "activecampaign.svg",
          status: "available",
          popular: false
        }
      ]
    },
    {
      ...
      integrations: [
        ...
        {
          name: "Pipedrive",
          description: "Add leads to Pipedrive pipeline",
          logo: "pipedrive.svg",
          status: "available",
          popular: false
        }
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "native":
        return <Badge className="bg-green-100 text-green-700 border-green-200">Native</Badge>;
      case "available":
